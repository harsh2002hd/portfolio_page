      ...
      <div className="max-w-7xl w-full grid md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg">
            Currently pursuing my BE in Electronics & Communication Engineering at MBM University, Jodhpur, I combine academic knowledge with hands-on experience to deliver high-quality solutions for complex technical challenges.
          </p>
